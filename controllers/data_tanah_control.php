	...
	if(isset($_GET['model'])): // for secure
		...
		if($model == 'tanah' AND $method == 'tambah') {
			if(isset($_POST['tambah'])) {
				...
				if (empty($kode_barang)) {
					...
					$tanah->insertData($kode_barang, $jenis_barang, $register, $luas_tanah, $tanggal_beli, $alamat, $hak, $no_sertifikat, 
						$tanggal_sertifikat, $penggunaan, $asal_usul, $harga, $keterangan);
		...
		if($model == 'tanah' AND $method == 'edit') {
			if(isset($_POST['edit'])) {
				...
				$tanah->updateData($kode_barang, $jenis_barang, $register, $luas_tanah, $tanggal_beli, $alamat, $hak, $no_sertifikat, 
					$tanggal_sertifikat, $penggunaan, $asal_usul, $harga, $keterangan, $id);
